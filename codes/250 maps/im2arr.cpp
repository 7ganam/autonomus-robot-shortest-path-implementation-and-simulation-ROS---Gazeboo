   ...
   //read the pixel values of the red layer of image in the directory and store it in "myarray" int array
        for(int i=0;i<m;i++)
        {
            for(int j=0;j<n ;j++)
            {
                ...
                Image  img("/home/ganam/Desktop/binary factor/250 maps/image_250_9.jpg");
        ...
        fstream myfile0("binary_250_9.bin",ios::out  | ios::trunc | ios::binary|ios::in);
        myfile0.close();
        
        // open "myfile1.bin" in suitable writing mode
        fstream myfile("binary_250_9.bin",ios::out  | ios::app | ios::binary |ios::in);
