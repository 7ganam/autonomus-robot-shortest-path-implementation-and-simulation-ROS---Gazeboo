...
// map information
const char* map_image_direcotry="/home/ganam/Desktop/binary factor/250 maps/image_250_4.jpg";
const char* map_binary_directory="binary_250_4.bin";
string input_type="binary";   //define the input type either (image or binary)
const int m=250;    // map rows
const int n=250;    // map coloms

int x_start= 10;        //  start x poistion 
int y_start=109;        //  start y postion 
int x_goal=240;         //  goal  x postion
int y_goal=240;         //  goal  y postion
