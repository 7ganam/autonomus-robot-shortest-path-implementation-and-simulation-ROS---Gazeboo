...
//          if(x=xg && yg>y )  {thg=90;}
//          else if(x=xg && yg<y )   {thg=270;}  
//          else
//          {
              thg=  atan ((yg-y)/(xg-x)) * 180 / 3.14;

              if(thg <0 && yg>y)  {thg=180+thg;}
              if(thg <0 && yg<y)  {thg=360+thg;}

              if(thg >0 && yg>y)  {thg=thg;}
              if(thg >0 && yg<y)  {thg=180+thg;}
//          }
        ...
        if (th != thg && abs(thdiff)>50)
        {
          ...
          cout<<"x="<<x<<endl; cout<<"y="<<y<<endl;  cout<<"th="<<th<<endl; cout<<"thg="<<thg<<endl;
        }
        else if (th != thg && abs(thdiff)<20  && abs(thdiff)>5)
        {
          geom.linear.x=0;  geom.linear.y=0; geom.linear.z=0;  geom.angular.x=0; geom.angular.y=0; 
